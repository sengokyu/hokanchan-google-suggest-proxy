...
This is a sample template for hokanchan - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name hokanchan --tail
```
...
```bash
aws cloudformation delete-stack --stack-name hokanchan
```
